...
const Home = () => {
  ...
  } = useQuery(GET_INCOME_CATEGORIES);
  const {
    data: allCategories,
  ...
  // muatation
  const [createTransaction, { loading: createTransLoading }] = useMutation(
    ADD_EXPENCE_TRANSACTION,
    {
      refetchQueries: [GET_WALLET_BY_ID, GET_TRANSACTIONS],
    }
  );
            ...
            <div className="flex py-2 flex-auto justify-between rounded-md border border-soldi border-gray-400 items-center lg:w-[45%] px-4">
              <div className="left flex items-center gap-[4px]">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-gray-925 text-sm lg:text-lg font-semibold">
